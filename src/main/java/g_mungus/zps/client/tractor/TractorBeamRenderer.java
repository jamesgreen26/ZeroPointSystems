...
public final class TractorBeamRenderer {
    ...
    public static void onRenderLevelStage(RenderLevelStageEvent event) {
        ...
        for (RunningBeams.Entry entry : beams) {
            ...
            MeshData mesh = buildHull(beam, entry.scanFor(level, shown), shown, pose);
            if (mesh != null) {
     ...
     */
    private static @Nullable MeshData buildHull(BeamGeometry beam, BeamScan scan, float shown, Matrix4f pose) {
        BufferBuilder builder = Tesselator.getInstance()
                .begin(VertexFormat.Mode.QUADS, DefaultVertexFormat.POSITION_TEX_LIGHTMAP_COLOR);
    ...
    private static void vertex(BufferBuilder builder, Matrix4f pose, BeamGeometry beam, Direction.Axis fixedAxis,
        ...
        builder.addVertex(pose, x, y, z)
                .setUv(acrossA, acrossB)
                .setUv2(Math.round(distance * DISTANCE_STEPS), 0)
                .setColor(255, 255, 255, STRENGTH);
    }
