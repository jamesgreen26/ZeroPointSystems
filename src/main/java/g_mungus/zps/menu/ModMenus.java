...
public class ModMenus {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<BeamCollectorMenu>> BEAM_COLLECTOR =
            MENUS.register("beam_collector", () -> IMenuTypeExtension.create(BeamCollectorMenu::new));
