...
public class RollingMillMenu extends RecipeBookMenu<Container> {
    ...
    public boolean recipeMatches(@NotNull Recipe<? super Container> recipe) {
        ...
        return level != null && recipe.matches(new SimpleContainer(this.getSlot(INPUT_SLOT).getItem()), level);
    }
