...
public final class PowderSnowCauldronScoop {
    ...
    public static void register() {
        CauldronInteraction.POWDER_SNOW.map().put(Items.AIR, PowderSnowCauldronScoop::scoop);
    }

    private static ItemInteractionResult scoop(BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, ItemStack stack) {
