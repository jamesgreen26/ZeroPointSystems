...
public class ConnectedGeometry implements IUnbakedGeometry<ConnectedGeometry> {
    ...
    public BakedModel bake(IGeometryBakingContext context, ModelBaker baker,
        ...
        BakedModel baked = inner.bake(baker, spriteGetter, modelState, modelLocation);
        if (uvLocked != null) {
            BakedModel locked = uvLocked.bake(baker, spriteGetter, new SimpleModelState(modelState.getRotation(), true), modelLocation);
