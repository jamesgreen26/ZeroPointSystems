...
public class PowderSnowCauldronGameTests {
    ...
    public static void sneakEmptyHand_takesOneLayerAsSnowball(GameTestHelper helper) {
        ...
        ItemInteractionResult result = use(helper, player);
    ...
    private static ItemInteractionResult use(GameTestHelper helper, Player player) {
        BlockPos abs = helper.absolutePos(CAULDRON);
        BlockHitResult hit = new BlockHitResult(Vec3.atCenterOf(abs), Direction.UP, abs, false);
        return helper.getBlockState(CAULDRON).useItemOn(
