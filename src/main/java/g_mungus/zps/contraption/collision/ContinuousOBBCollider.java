...
/**
 * Continuous oriented-bounding-box collider producing a separation manifold
 * (time of impact, normal, separation vector). Clean-room port of Create's
 * collision ContinuousOBBCollider (no com.simibubi.* dependency).
 */
