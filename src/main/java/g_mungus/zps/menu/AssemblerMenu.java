...
public class AssemblerMenu extends RecipeBookMenu<CraftingContainer> {
     ...
     */
    @Override
    public void handlePlacement(boolean placeAll, @NotNull Recipe<?> recipe, @NotNull ServerPlayer player) {
