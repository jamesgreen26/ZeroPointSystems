...
public final class ZPSMod {
    ...
    private static void registerGameTests(RegisterGameTestsEvent event) {
        ...
        event.register(TractorBeamGameTests.class);
        event.register(TractorBeamSableGameTests.class);
    ...
    private static void registerCapabilities(RegisterCapabilitiesEvent event) {
        ...
        event.registerBlockEntity(Capabilities.EnergyStorage.BLOCK, ModBlockEntities.BEAM_COLLECTOR.get(), BeamCollectorBlockEntity::getEnergyStorage);
        event.registerBlockEntity(Capabilities.ItemHandler.BLOCK, ModBlockEntities.BEAM_COLLECTOR.get(), BeamCollectorBlockEntity::getItemHandler);
