...
public final class ReactorGlowMesh implements AutoCloseable {
    ...
    public static @Nullable ReactorGlowMesh build(VoxelShape shape, @Nullable BlockAndTintGetter walls) {
        ...
        try (ByteBufferBuilder bytes = new ByteBufferBuilder(capacity);
             ByteBufferBuilder windowBytes = new ByteBufferBuilder(DefaultVertexFormat.BLOCK.getVertexSize() * 4 * 16)) {
            BufferBuilder builder = new BufferBuilder(bytes, VertexFormat.Mode.QUADS, DefaultVertexFormat.POSITION_COLOR_NORMAL);
            BufferBuilder windowBuilder = new BufferBuilder(windowBytes, VertexFormat.Mode.QUADS, DefaultVertexFormat.BLOCK);
            ...
            MeshData windowData = windowBuilder.build();
            VertexBuffer windows = windowData == null ? null : upload(windowData);
    ...
    private static VertexBuffer upload(MeshData data) {
