...
public class ZPSConfig {
    ...
    private static ModConfigSpec.ConfigValue<Double> exchangerTemperatureK;
    private static ModConfigSpec.ConfigValue<Double> burstPressurePa;
    ...
    private static ModConfigSpec.ConfigValue<Integer> combustionGeneratorFePerTick;
    private static ModConfigSpec.ConfigValue<Double> exchangerJoulesPerFe;
    private static ModConfigSpec.ConfigValue<Integer> standardTransferFePerTick;
