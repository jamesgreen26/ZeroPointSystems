...
public class GasGaugeBlockEntityRenderer implements BlockEntityRenderer<GasGaugeBlockEntity> {
    ...
    public static final ResourceLocation NEEDLE_MODEL =
            ZPSMod.resource("block/gas_gauge/needle");
    /** The same needle in blue, which reads pressure: the colour is how the mode is told at a glance. */
    public static final ResourceLocation PRESSURE_NEEDLE_MODEL =
            ZPSMod.resource("block/gas_gauge/needle_pressure");
